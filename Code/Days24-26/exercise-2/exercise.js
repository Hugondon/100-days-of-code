...
let addBlueBackgroundButton = document.getElementById('blue-background-btn')
...
function addBlueBackground(event) {
  ...
  //   thirdParagraph.style.backgroundColor = 'rgb(112, 211, 231)'
  thirdParagraph.className = 'third-paragraph'
}

removeParagraphButton.addEventListener('click', removeParagraph)
addBlueBackgroundButton.addEventListener('click', addBlueBackground)
